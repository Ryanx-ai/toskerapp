...
| `TOS.PERSONAL.ROOM.01` | `/personal/my-room` | My Room and self-messaging |
...
| `TOS.ONBOARD.MYROOM.01` | `/personal/my-room` in Fresh account | Empty My Room and first self-message |
| `TOS.EMPTY.PERSONAL.01` | Fresh account, Personal selected | No personal chats |
| `TOS.EMPTY.ROOMS.01` | Fresh account, Rooms selected | No Rooms and creation actions |
