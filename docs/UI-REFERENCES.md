...
## Destination banners and rail states

`WorkspaceBanner` owns title, supporting copy, optional action, intensity, and an independent atmosphere slot. Geometry is complete without artwork. Explore may be expressive; Marketplace and Studio use richer colour fields; Settings, Help, Friends, and Notifications stay quiet.

The desktop rail has expanded and 76px collapsed states. Collapsed mode exposes product icons, conversation avatars, profile actions, and clear hover names without compressing text. Mobile never inherits desktop collapse state.
