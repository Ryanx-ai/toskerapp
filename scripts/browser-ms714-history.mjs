...
assert.equal(seen.size, 525, "Entire 525-row history traversed in a bounded DOM");
...
console.log("PASS: 525-row browser history, 50-row pages, 200-node cap, stable anchors/no duplicates, oldest boundary, incoming activity holds reading position, forward page and Latest recover canonical arrival.");
