...
const samples = [];
for (const [context, path] of [["Personal", "/personal/chat-be192eac-38c6-4d46-a6d2-bea19fa324fa"], ["Room", room], ["Subroom", `${room}/subroom/4dabe4eb-acf4-4e5c-aac9-c12eb0614dd4`]]) {
