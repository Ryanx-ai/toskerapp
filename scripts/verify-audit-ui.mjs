...
const snapshot = { userId: "actor-a", navigation: { rooms: [], personalConversations: [] }, activity: [{ id: "activity-a" }], preferences: [{conversationId:"a-chat",muted:true,manualChatUnreadId:"a-marker"}], navigationBasis: {} };
let updates = 0;
...
assert.equal(cache.get("actor-b").preferences.length, 0, "Private mute/manual read state stays actor-scoped");
